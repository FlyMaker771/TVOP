...
<body>
    ...
    <div class="body image">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <!-- logo texar -->
                <a class="navbar-brand" href="#"><img src="logoTexar.png" style="width:50px; object-fit: cover;" alt=""><img src="LOGO SMKASSALAM.png" style="width:50px; object-fit: cover;" alt=""></a>
                <a class="navbar-brand" href="#">Texas Voice</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        Copyright &copy; 2023 Tim Extrakulikuler Tixar All rights reserved.
                    </div>
                </div>
            </div>
        </div>
