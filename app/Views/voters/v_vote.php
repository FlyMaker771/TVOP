...
<body>
    ...
    <!-- Header -->
    <!-- <header class="bg-light text-center mrg image">
        <div class="container bod">
            <h1 style="color: white;">Selamat Datang di Web Pembayaran SPP SMK TEXAR</h1>
            <p>Bayar jadi lebih mudah dengan teknologi!</p>
        </div>
    </header>
 -->
    <!-- Menu -->
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-md-4 col-sm-4 col-6">
                        <a id="detail" data-id="<?= $item->id_kandidat; ?>" data-nama="<?= $item->nama; ?>" data-nis="<?= $item->nis; ?>" data-foto="<?= $item->foto; ?>" data-visi="<?= $item->visi; ?>" data-misi="<?= $item->misi; ?>" data-bs-toggle="modal" data-bs-target="#modal-detail" style="text-decoration: none;">
                            <div class="card mb-4">
                                <img src="/img/<?= $item->foto; ?>" class="card-img-top crop" alt="Kopi 1" width="85">
                                <div class="card-body">
                                    <h5 class="card-title"><?= $item->nama; ?></h5>
                                    <p class="card-text"><?= $item->nis; ?></p>
                                    <a id="detail" class="btn btn-primary right-button card-button detail" data-bs-toggle="modal" data-bs-target="#modal-detail" data-id="<?= $item->id_kandidat; ?>" data-nama="<?= $item->nama; ?>" data-nis="<?= $item->nis; ?>" data-foto="<?= $item->foto; ?>" data-visi="<?= $item->visi; ?>" data-misi="<?= $item->misi; ?>">Vote</a>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <footer class="text-center py-3">
        <p>&copy; 2023 Tim Ekstrakulikuler Tixar</p>
    </footer>
